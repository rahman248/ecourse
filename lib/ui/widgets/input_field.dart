...
class InputField extends StatefulWidget {
  ...
  const InputField(
      { Key? key,
        ...
        this.smallVersion = false}) : super(key: key);
    ...
    return Column(
      ...
      children: <Widget>[
            ...
            children: <Widget>[
              Expanded(
                child: TextFormField(
                  ...
                  inputFormatters:
                  widget.formatter != null ? [widget.formatter as TextInputFormatter] : null,
                  onEditingComplete: () {
        ...
        if (widget.validationMessage != null)
          NoteText(
            widget.validationMessage as String,
            color: Colors.red,
          ),
        if (widget.additionalNote != null) verticalSpace(5),
        if (widget.additionalNote != null) NoteText(widget.additionalNote as String),
        verticalSpaceSmall
      ],
    );
  }
